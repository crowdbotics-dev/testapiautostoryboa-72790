...
## Project Structure
    ...
    ├── testapiautostoryboa_72790  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_72790`
...
2. Clone this repo and `cd testapiautostoryboa_72790`
